...
void CDockAreaTitleBar::mouseMoveEvent(QMouseEvent* ev)
{
	...
	// If one single dock frameLessWidget in this area is not floatable then the whole
	// area is not floatable
	// We can create the floating drag preview if the dock frameLessWidget is movable
