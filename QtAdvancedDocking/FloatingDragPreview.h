...
/**
 * A floating overlay is a temporary floating frameLessWidget that is just used to
 * indicate the floating frameLessWidget movement.
 * This frameLessWidget is used as a placeholder for drag operations for non-opaque
 * docking
 */
...
public:
    ...
    /**
     * We filter the events of the assigned content frameLessWidget to receive
...
public: // implements IFloatingWidget -----------------------------------------
	 ...
	 * of the assigned Content frameLessWidget
	 */
	virtual void finishDragging() override;

	/**
	 * Cleanup auto hide container if the dragged frameLessWidget has one
	 */
