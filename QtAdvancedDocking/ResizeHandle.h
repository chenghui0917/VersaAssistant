...
/**
 * Resize handle for resizing its parent frameLessWidget
 */
...
public:
	...
	/**
	 * Sets the minimum size for the frameLessWidget that is going to be resized.
	 * The resize handle will not resize the target frameLessWidget to a size smaller
	 * than this value
	 */
	void setMinResizeSize(int MinSize);

	/**
	 * Sets the maximum size for the frameLessWidget that is going to be resized
	 * The resize handle will not resize the target frameLessWidget to a size bigger
	 * than this value
	 */
