...
public:
	...
	/**
	 * Returns first frameLessWidget or nullptr if splitter is empty
	 */
	QWidget* firstWidget() const;

	/**
	 * Returns last frameLessWidget of nullptr is splitter is empty
	 */
	QWidget* lastWidget() const;

    /**
     * Returns true if the splitter contains central frameLessWidget of dock manager.
     */
