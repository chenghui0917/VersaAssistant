 ...
 * The title bar contains a tabbar with all tabs for a dock frameLessWidget group and
...
protected:
	 ...
	 * if it is not the last dock area in a floating frameLessWidget
	 */
...
public:
	...
	/**
	 * Updates the visibility of the dock frameLessWidget actions in the title bar
	 */
	...
	/**
	 * Inserts a custom frameLessWidget at position index into this title bar.
	 * If index is negative, the frameLessWidget is added at the end.
	 * You can use this function to insert custom widgets into the title bar.
	 */
	void insertWidget(int index, QWidget *widget);

	/**
	 * Searches for frameLessWidget frameLessWidget in this title bar.
	 * You can use this function, to get the position of the default
	 * frameLessWidget in the tile bar.
	 * \code
	 ...
	 * Auto hide widgets can only have one dock frameLessWidget so it does not make sense for the tooltip to show close group
	 */
