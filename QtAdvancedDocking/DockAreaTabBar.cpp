...
void CDockAreaTabBar::onCloseOtherTabsRequested()
{
	...
	for (int i = 0; i < count(); ++i)
	{
		...
		{
			// If the dock frameLessWidget is deleted with the closeTab() call, its tab
			...
			// If the the dock frameLessWidget blocks closing, i.e. if the flag
			// CustomCloseHandling is set, and the dock frameLessWidget is still open,
