...
/**
 * Replace the from frameLessWidget in the given splitter with the To frameLessWidget
 */
...
/**
 * Returns the SieBarLocation for the AutoHide dock frameLessWidget areas
 */
...
/**
 * Searches for the parent frameLessWidget of the given type.
 * Returns the parent frameLessWidget of the given frameLessWidget or 0 if the frameLessWidget is not
 * child of any frameLessWidget of type T
 *
 * It is not safe to use this function in in CDockWidget because only
 * the current dock frameLessWidget has a parent. All dock widgets that are not the
 * current dock frameLessWidget in a dock area have no parent.
 */
template <class T>
 ...
 * Use this function to set the icons for the dock area and dock frameLessWidget buttons.
...
/**
 * Calls unpolish() / polish for the style of the given frameLessWidget to update
...
/**
 * Returns the geometry of the given frameLessWidget in global space
 */
