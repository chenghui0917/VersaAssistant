...
/**
 * A dock frameLessWidget Side tab that shows a title or an icon.
 * The dock frameLessWidget tab is shown in the side tab bar to switch between
 * pinned dock widgets
 */
...
public:
	 ...
	 * hide frameLessWidget is visible
	 */
	bool isActiveTab() const;

	/**
	 * returns the dock frameLessWidget this belongs to
	 */
	CDockWidget* dockWidget() const;

	/**
	 * Sets the dock frameLessWidget that is controlled by this tab
	 */
...
public Q_SLOTS:
	/**
	 * Set the dock frameLessWidget floating, if it is floatable
	 */
	void setDockWidgetFloating();

	/**
	 * Unpin and dock the auto hide frameLessWidget
	 */
	void unpinDockWidget();

	/**
	 * Calls the requestCloseDockWidget() function for the assigned dock frameLessWidget
	 */
