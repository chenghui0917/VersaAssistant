...
struct FloatingDockContainerPrivate
{
	...
	/**
	 * Reflect the current dock frameLessWidget title in the floating frameLessWidget windowTitle()
	...
	/**
	 * Handles escape key press when dragging around the floating frameLessWidget
	 */
...
void FloatingDockContainerPrivate::titleMouseReleaseEvent()
{
	 ...
	 || DockManager->containerOverlay()->dropAreaUnderCursor() != InvalidDockWidgetArea)
	{
		...
		{
			// Resize the floating frameLessWidget to the size of the highlighted drop area
			// rectangle
...
void CFloatingDockContainer::changeEvent(QEvent *event)
{
	...
	case QEvent::WindowStateChange:
		...
		// case, we restore the maximized state of this floating frameLessWidget
...
void CFloatingDockContainer::moveFloating()
{
	...
	case DraggingFloatingWidget:
		...
		// that by resetting the active window to the floating frameLessWidget after
...
{
	// VersaWidget has been redocked, so it must be hidden right way (see
...
bool CFloatingDockContainer::event(QEvent *e)
{
	...
	case DraggingMousePressed:
		...
		case QEvent::Resize:
			...
			// then dragging the window via title bar will cause the frameLessWidget to
