...
/*!
 * DockOverlay paints a translucent rectangle over another frameLessWidget. The geometry
...
public:
	...
	/**
	 * Show the drop overly for the given target frameLessWidget
	 */
	 ...
	 * the future area of the dropped frameLessWidget
	 */
...
public:
	...
	/**
	 * Returns the dock frameLessWidget area depending on the current cursor location.
	 * The function checks, if the mouse cursor is inside of any drop indicator
	 * frameLessWidget and returns the corresponding DockWidgetArea.
	 */
