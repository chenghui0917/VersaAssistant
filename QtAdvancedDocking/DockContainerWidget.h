...
protected:
	 ...
	 * Initializing inserts the tabs into the side tab frameLessWidget and hides it
	...
	/**
	 * Drop floating frameLessWidget into the container
	 */
	void dropFloatingWidget(CFloatingDockContainer* FloatingWidget, const QPoint& TargetPos);

	/**
	 * Drop a dock area or a dock frameLessWidget given in frameLessWidget parameter.
	...
	/**
	 * Adds the given dock area to this container frameLessWidget
	 */
	...
	/**
	 * This function returns the last added dock area frameLessWidget for the given
	 * area identifier or 0 if no dock area frameLessWidget has been added for the given
	 * area
	 */
	 ...
	 * one and only visible dock frameLessWidget. Otherwise it returns a nullptr.
	 */
    ...
    /**
     * This function returns a list of all dock widgets in this floating frameLessWidget.
     * It may be possible, depending on the implementation, that dock widgets,
     * that are not visible to the user have no parent frameLessWidget. Therefore simply
    ...
    /**
	 * Remove the given auto hide frameLessWidget from the list of registered auto hide
	 * widgets
	 */
    void removeAutoHideWidget(CAutoHideDockContainer* AutoHideWidget);

    /**
     * Handles frameLessWidget events of auto hide widgets to trigger delayed show
...
public:
	 ...
	 * higher than the index of the container frameLessWidget given in Other parameter
	 */
     ...
     * visible dock frameLessWidget.
     * A top level frameLessWidget is a real floating frameLessWidget. Only the isFloating()
	...
	/**
	 * This function returns true, if this container is in a floating frameLessWidget
	 */
	 ...
	 * means, if only dock frameLessWidget does not support a certain flag, the whole
	 * dock are does not support the flag.
	 */
	CDockWidget::DockWidgetFeatures features() const;

	/**
	 * If this dock container is in a floating frameLessWidget, this function returns
	 * the floating frameLessWidget.
	...
	/**
	 * Returns the side tab frameLessWidget for the given area
	 */
	 ...
	 * The content rectangle is the rectangle of the dock manager frameLessWidget minus
...
Q_SIGNALS:
	...
	/**
	 * This signal is emitted, if a new auto hide frameLessWidget has been created.
	 */
