...
/**
* This spacer frameLessWidget is here because of the following problem.
* The dock area title bar handles mouse dragging and moving the floating frameLessWidget.
* The  problem is, that if the title bar becomes invisible, i.e. if the dock
* area contains only one single dock frameLessWidget and the dock area is moved
* into a floating frameLessWidget, then mouse events are not handled anymore and dragging
* of the floating frameLessWidget stops.
*/
