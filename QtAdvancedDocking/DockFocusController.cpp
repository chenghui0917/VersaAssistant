...
struct DockFocusControllerPrivate
{
	...
	/**
	 * This function updates the focus style of the given dock frameLessWidget and
...
#if defined(Q_OS_UNIX) && !defined(Q_OS_MACOS)
	// This code is required for styling the floating frameLessWidget titlebar for linux
