...
/**
 * Side tab bar frameLessWidget that is shown at the edges of a dock container.
...
protected:
	...
	/**
	 * Inserts the given dock frameLessWidget tab at the given position.
...
public:
	...
	/**
	 * Insert dock frameLessWidget into the side bar.
	...
	/**
	 * Removes the auto hide frameLessWidget from this side bar
	 */
	...
	/*
	 * Get the side tab frameLessWidget at position, returns nullptr if it's out of bounds
	 */
	...
	/**
	 * Returns the number of visible tabs to its parent frameLessWidget.
	 */
	int visibleTabCount() const;

	/**
	 * Returns true, if the sidebar contains visible tabs to its parent frameLessWidget.
